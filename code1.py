...
client = wolframalpha.Client('8WL3HL-Q668XPTUGY')

folder = 'C:\\Users\\Bishal\\Desktop\\project\\music\\'

engine = pyttsx3.init()
voices = engine.getProperty('voices')

b_music = ['Friday-night-synthwave-electronic-music']
pygame.mixer.init()
...
class Widget:
    def __init__(self):
       root = Tk()
       root.title('FAVA(MK-1)')
       root.config(background='Red')
       root.geometry('600x600')
       root.resizable(0, 0)
       root.iconbitmap(r'C:\Users\Bishal\Desktop\project\Untitled-1.ico')
       img = ImageTk.PhotoImage(Image.open(r"C:\Users\Bishal\Desktop\project\origi.png"))
       ...
       compFrame = LabelFrame(root, text="FAVA", font=('Black ops one', 10, 'bold'))
       ...
       btn = Button(root, text='Start Listening!', font=('Black ops one', 10, 'bold'), bg='deepSkyBlue', fg='white', command=self.clicked).pack(fill='x', expand='yes')
       btn2 = Button(root, text='Close!', font=('Black Ops One', 10, 'bold'), bg='deepSkyBlue', fg='white', command=root.destroy).pack(fill='x', expand='yes')
    ...
    def clicked(self):
        ...
        if 'open ccleaner' in query:
            ...
            recipient = self.userText.set(recipient)
            recipient = recipient.lower()command()
            ...
            if 'me' in recipient:
                try:
                        ...
                        server.ehlo()
                        server.starttls()
                        server.login("fava.assistant@gmail.com", 'favaassistant2020')
                        server.sendmail('fava.assitant@gmail.com', content)
                        server.close()
            ...
            music_folder = 'C:\\Users\\Bishal\\Desktop\\project\\music\\'
            music = ['Friday-night-synthwave-electronic-music']
